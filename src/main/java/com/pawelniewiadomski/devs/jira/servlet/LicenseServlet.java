 ...
 *
 * This servlet can be reached at http://localhost:2990/jira/plugins/servlet/com.pawelniewiadomski.devs.jira.jira-bulk-create-plugin/license
 */
public class LicenseServlet extends HttpServlet
{
    private static final String TEMPLATE = "com/pawelniewiadomski/devs/jira/views/license-admin.vm";
    ...
    @Nonnull
    public static URI getServletLocation(@Nonnull String baseUrl) {
        return URI.create(baseUrl + "/plugins/servlet/com.pawelniewiadomski.devs.jira.jira-bulk-create-plugin/license");
    }

    private Map<String, Object> initVelocityContext(HttpServletResponse resp)
    {
        resp.setContentType("text/html;charset=utf-8");
        URI servletUri = getServletLocation(applicationProperties.getBaseUrl());
